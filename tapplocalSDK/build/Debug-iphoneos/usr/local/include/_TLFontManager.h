...
@interface _TLFontManager : NSObject {
	CFMutableDictionaryRef fonts;
	NSMutableDictionary *urls;
}
+ (_TLFontManager *)sharedManager;
/*!
    @method     
...
/*!
	...
	@discussion If the font has not been loaded yet, -loadFont: will be
				called with the given name first.
*/
- (_TLZFont *)zFontWithName:(NSString *)filename pointSize:(CGFloat)pointSize;
/*!
	@method
...
*/
- (_TLZFont *)zFontWithURL:(NSURL *)url pointSize:(CGFloat)pointSize;
/*!
	@method
