...
@interface NSString (_TLFontLabelStringDrawing)
...
// ZFont-based methods
- (CGSize)sizeWithZFont:(_TLZFont *)font;
- (CGSize)sizeWithZFont:(_TLZFont *)font constrainedToSize:(CGSize)size;
- (CGSize)sizeWithZFont:(_TLZFont *)font constrainedToSize:(CGSize)size lineBreakMode:(UILineBreakMode)lineBreakMode;
- (CGSize)sizeWithZFont:(_TLZFont *)font constrainedToSize:(CGSize)size lineBreakMode:(UILineBreakMode)lineBreakMode
		  numberOfLines:(NSUInteger)numberOfLines;
- (CGSize)drawAtPoint:(CGPoint)point withZFont:(_TLZFont *)font;
- (CGSize)drawAtPoint:(CGPoint)point forWidth:(CGFloat)width withZFont:(_TLZFont *)font lineBreakMode:(UILineBreakMode)lineBreakMode;
- (CGSize)drawInRect:(CGRect)rect withZFont:(_TLZFont *)font;
- (CGSize)drawInRect:(CGRect)rect withZFont:(_TLZFont *)font lineBreakMode:(UILineBreakMode)lineBreakMode;
- (CGSize)drawInRect:(CGRect)rect withZFont:(_TLZFont *)font lineBreakMode:(UILineBreakMode)lineBreakMode
